...
#define OPERATION_MODE DEEP_SLEEP_OPERATION
// In seconds
...
setup_worker(void* arg) {
    if(OPERATION_MODE == DEEP_SLEEP_OPERATION) {
        read_and_publish_data();
